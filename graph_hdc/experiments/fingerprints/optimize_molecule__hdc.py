"""
HDC-based Molecular Optimization Experiment
...
via gradient descent to reach target property values.
...
Example:
    .. code-block:: bash
        ...
        # Run with debug mode
        python optimize_molecule__hdc.py

        # Run with configuration
        python -m pycomex run optimize_molecule__hdc__aqsoldb.yml
"""
import os
import time
...
#       but increase computational cost. For optimization, larger sizes may provide
#       smoother gradients.
...
def process_dataset(e: Experiment,
    ...
    particularly well-suited for gradient-based optimization due to:

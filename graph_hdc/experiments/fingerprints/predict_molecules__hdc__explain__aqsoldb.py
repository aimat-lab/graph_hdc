"""
Atom-level explanation experiment for the AqSolDB aqueous solubility dataset
with the HDC encoder.

Extends the base explanation experiment with AqSolDB-specific dataset
parameters.
"""
...
EXPLAIN_VIZ_CAP: float = 0.5

# == EXPERIMENT PARAMETERS ==

# Remove the INHERIT import name from globals so pycomex doesn't treat it as a parameter
del INHERIT
